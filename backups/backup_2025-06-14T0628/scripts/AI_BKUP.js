...
function generateBackupTree(backupPath) {
    ...
    function scanDirectory(dir, prefix = '', isLast = true) {
        ...
        entries.forEach((entry, index) => {
            ...
            // Use ANSI escape codes to color the icons
            const coloredIcon = isDirectory ? '\x1b[34m' + icon + '\x1b[0m' : '\x1b[32m' + icon + '\x1b[0m';
            
            tree.push(`${prefix}${marker}${coloredIcon} ${entry}${size}`);
