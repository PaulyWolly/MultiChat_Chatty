...
function generateBackupTree(backupPath) {
    ...
    // Read the SVG icons
    const folderIcon = fs.readFileSync(path.join(__dirname, '..', 'public', 'assets', 'img', 'icons', 'folder.svg'), 'utf8');
    const fileIcon = fs.readFileSync(path.join(__dirname, '..', 'public', 'assets', 'img', 'icons', 'file.svg'), 'utf8');
