...
export default class QuotaMonitor {
    constructor() {
        ...
        this.dailyLimit = 10000; // Standard free tier daily quota
        this.warningThresholds = {
            yellow: 0.3,   // 30% - Show warning (3,000 calls)
            orange: 0.6,   // 60% - Show caution (6,000 calls)
            red: 0.85      // 85% - Show critical warning (8,500 calls)
        };
    ...
    injectCSS() {
        ...
        style.textContent = `
            ...
            .quota-toggle-cache-mode-btn:hover {
                opacity: 0.8;
            }
        `;
    ...
    getQuotaDashboardHTML() {
        ...
        if (isMinimized) {
            ...
            return `
                <button id="quota-restore-btn" class="quota-minimize-restore-btn quota-restore-btn" title="Restore dashboard">[ O ]</button>
            ...
            return `
                ...
                <div class="quota-content-restored">
                    ...
                    <div class="quota-actions">
                        ...
                        <button class="quota-test-warnings-btn" id="quota-test-warnings" style="background: #9c27b0; width: 100%; font-size: 10px; margin-top: 4px;">
                            🧪 Test Warnings
                        </button>
                    </div>
                </div>
    ...
    attachDashboardEvents(dashboard) {
        ...
        const testBtn = dashboard.querySelector('#quota-test-warnings');
     ...
     */
    testWarnings() {
        console.log('🧪 [QUOTA] Testing warning thresholds...');
        
        // Test yellow warning (30%)
        const testYellow = Math.floor(this.dailyLimit * this.warningThresholds.yellow);
        console.log(`🧪 [QUOTA] Testing yellow warning at ${testYellow} calls`);
        this.checkThresholds(testYellow);
        
        // Test orange warning (60%)
        const testOrange = Math.floor(this.dailyLimit * this.warningThresholds.orange);
        console.log(`🧪 [QUOTA] Testing orange warning at ${testOrange} calls`);
        this.checkThresholds(testOrange);
        
        // Test red warning (85%)
        const testRed = Math.floor(this.dailyLimit * this.warningThresholds.red);
        console.log(`🧪 [QUOTA] Testing red warning at ${testRed} calls`);
        this.checkThresholds(testRed);
    }
} 