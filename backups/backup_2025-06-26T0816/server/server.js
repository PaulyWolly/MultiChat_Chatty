    ...
    if (type === 'movies' || type === 'tv') {
        ...
        try {
            const result = await getCachedOrFetch(cacheKey, async () => {
                ...
                if (type === 'movies') {
                    searchQuery = `${query} movie full movie trailer`;
                } else if (type === 'tv') {
                    searchQuery = `${query} tv show series episode`;
                }
                ...
                const searchResponse = await youtube.search.list({
                    ...
                    maxResults: perPage,
                    type: 'video',
                    videoDuration: 'any', // Allow any duration for movies/TV
