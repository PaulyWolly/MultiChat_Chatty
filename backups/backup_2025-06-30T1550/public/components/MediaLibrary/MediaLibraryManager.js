...
class MediaLibraryManager {
    ...
    renderGrid(items, labelFn) {
        ...
        items.forEach(item => {
            grid += `
                <div class="media-library-movie-card">
                    <img src="${item.poster}" alt="${labelFn(item)}">
                    <div style="text-align:center; padding: 8px 4px 0 4px;">
                        <div style="font-weight:600; font-size:14px; color:#333; margin-bottom:2px;">${labelFn(item)}</div>
