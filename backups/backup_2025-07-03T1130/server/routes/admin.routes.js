...
function getScriptCategory(scriptName) {
  const categories = {
    'movies': ['scan_media_library_movies.js', 'fetch_tv_posters.js', 'convert_tv_posters.js'],
    'tv-shows': ['scan_media_library_tv-shows.js', 'fetch_tmdb_posters_tv-shows.js', 'fetch_tmdb_tv-show_season_images.js', 'fetch_tmdb_tv-show_episode_images.js', 'download_tv_images.js', 'setup_tmdb.js', 'test_tv_images.js'],
    ...
    'development': ['playlist-duration-backfill.js', 'merge-santana-json.js', 'merge-playlist-duplicates.js', 'convert_old_to_new_cachekeys_for_santanta.js', 'clean-localStorage-cache.js', 'update_release-notes_readme.mjs', 'update_headers.mjs', 'see_colors.js', 'refactor-api-calls.js', 'download-icons.js', 'download-mock-thumbs.js', 'VALIDATE_FUNCTIONS.js', 'test_script_manager.js']
  };
