        ...
        if (this.currentCategory === 'movies' || this.currentCategory === 'tv-shows') {
            ...
            scriptsList.innerHTML = `
                <div class="scripts-header">
                    <h3>${groupTitle}</h3>
                    <p>To ensure all your videos play with audio in browsers, follow these steps:</p>
                </div>
...
// Create and expose a global instance for inline handlers
window.scriptManager = new ScriptManager();
window.scriptManager.init();

// Export for use in AdminPanel
