            ...
            document.querySelectorAll('.poster-selector-btn').forEach(btn => {
                btn.onclick = (e) => {
                    ...
                    if (window.PosterSelector) {
                        // Pass 'movie' as the mode if you want movie posters, or 'tv' for TV shows
                        const selector = new window.PosterSelector('movie');
                        // Optionally, you can set up context or callbacks here if needed
                        selector.init();
                    } else {
                        console.error('[PosterSelector] PosterSelector is not available. window.PosterSelector:', window.PosterSelector);
