    ...
    initPaginatorBars() {
        ...
        if (!document.getElementById('minimized-paginator-bar')) {
            ...
            minimizedBar.onclick = () => {
                ...
                // Always scroll to the top of the YouTube results when restoring
                const ytContainer = document.querySelector('.youtube-results-container, .youtube-list-container, .youtube-results, .youtube-multi-bubble, .youtube-single-bubble');
                if (ytContainer) {
