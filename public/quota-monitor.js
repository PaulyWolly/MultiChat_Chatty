...
const QuotaMonitor = {
            ...
            return `
                ...
                <div class="quota-content-restored">
                    ...
                    <div style="display: flex; gap: 6px; margin-top: 8px;">
                        <button id="quota-toggle-cache-mode" style="flex: 1; padding: 6px 8px; border: none; border-radius: 4px; font-size: 10px; cursor: pointer; background: ${cacheOnlyMode ? '#f44336' : '#4caf50'}; color: white;">
                            ${cacheOnlyMode ? '🔒 Cache-Only ON' : '🔓 Cache-Only OFF'}
                        </button>
                        <button id="quota-reset-counter" style="flex: 1; padding: 6px 8px; border: none; border-radius: 4px; font-size: 10px; cursor: pointer; background: #2196f3; color: white;">
                            🔄 Reset
                        </button>
                    </div>
                </div>
    ...
    attachDashboardEvents(dashboard) {
        ...
        const resetBtn = dashboard.querySelector('#quota-reset-counter');
