...
(async () => {
  ...
  const outPath = path.join(__dirname, '../public/data/movie_details_single.json');
  ...
  // 1. Merge description
  const descPath = path.join(__dirname, '../public/data/movie_descriptions.json');
  let descData = {};
  ...
  // 2. Merge cast
  const castPath = path.join(__dirname, '../public/data/movie_cast.json');
  let castData = {};
