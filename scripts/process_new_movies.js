...
const MEDIA_LIBRARY_FILE = path.join(__dirname, '../server/data/media-library-movies.json');
const POSTER_MAPPING_FILE = path.join(__dirname, '../public/components/MediaLibrary/data/movie_posters.json');
...
class NewMovieProcessor {
    ...
    async fetchGenresForNewMovies() {
        ...
        const GENRES_FILE = path.join(__dirname, 'movie_genres.json');
